...
function QnABoardPage() {
    ...
    return (
        <div className="board-container">
            <h1 className="board-header">QnA</h1>
            ...
            <div className="board-filter-container">
                <label className="board-label">
                    ...
                    <select value={selectGbn} onChange={(e) => { setSelectGbn(e.target.value); setCurrentPage(1); }} className="board-select">
                        ...
                        <option value="favorite">공지</option>
                        <option value="bid">일반</option>
                    </select>
                </label>
                <div className="board-filter-group-wide">
                    <label htmlFor="cltrNm" className="board-label">제목 검색</label>
                    <input type="text" id="cltrNm" value={cltrNm} onChange={(e) => setCltrNm(e.target.value)} placeholder="제목" className="board-input" />
                </div>
                <div className="board-filter-group-wide">
                    <label htmlFor="cltrNm" className="board-label">내용 검색</label>
                    <input type="text" id="cltrNm" value={cltrNm} onChange={(e) => setCltrNm(e.target.value)} placeholder="내용" className="board-input" />
                </div>
                (총 {totalCount}건)
                <div className="board-search-button-group">
                    <button onClick={handleWriteButtonClick} className="board-search-button">글쓰기</button>
            ...
            <Pagination />
            {isModalOpen && <DetailModal isOpen={isModalOpen} onClose={closeDetailModal} item={selectedItem} openPage="bidBoard" />}
        </div>
    );
}
